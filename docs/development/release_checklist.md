...
- [x] Ruff lint
- [x] mypy
- [x] pytest (84 test cases on Windows/Python 3.12)
- [x] PyCharm shared run configuration and legacy root launcher smoke
...
- [x] Documented alternative `Ctrl+Alt+Space` has no conflict on release test host
